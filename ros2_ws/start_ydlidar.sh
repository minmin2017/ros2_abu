...
source /home/minmin/ros2_ws/install/setup.bash
...
exec ros2 launch ydlidar_ros2_driver ydlidar_launch.py params_file:=/home/minmin/ros2_ws/src/ydlidar_ros2_driver/params/ydlidar.yaml
